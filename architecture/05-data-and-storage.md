...
53 tables, grouped into areas that map cleanly onto the product:
...
Every record is numbered 1, 2, 3. Chosen for consistency across all 53 tables, smaller and faster indexes, and readability in support conversations.
...
**Why:** auto-generated changes produce diffs nobody reads and miss data migrations entirely. There are 23 of these on this branch, and they run automatically when a new version is deployed.
...
**Why:** the whole system is ~25,000 lines of application code serving a single-tutor product. Splitting it would add network failures, distributed transactions and deployment coordination to buy independent scaling nobody needs.
