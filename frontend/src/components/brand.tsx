...
/**
 * PLACEHOLDER MARK. The approved Avora mark artwork is supplied separately.
 * Until it lands, this is a deliberate placeholder: a warm arch — an "aperture"
 * evoking "avora" — drawn in `currentColor` so it recolours with the surrounding
 * text. It is NOT the official mark. Replacing it is a one-component swap: drop
 * the real SVG paths in here (and in `public/favicon.svg`) and nothing else
 * changes, because every scale below composes this single component.
 */
