          ...
          <>
            <label className="block text-sm text-ink-700">
              ...
              <select
                ...
                className="mt-1 w-full max-w-xs rounded-md border border-line-strong bg-surface px-3 py-2 text-sm text-ink-900 focus:border-brand-500 focus:outline-none"
              >
                {options.map((g) => (
