...
| [`docs/avora-new-state-august-16.md`](avora-new-state-august-16.md) | The **programme plan** to reach the Avora target state — 90 product decisions recorded verbatim as the source of truth, 19 engineering decisions marked separately, and 12 phases of tasks written for AI agents and engineers to execute one at a time or in parallel | Yes, until Phase 11 lands |
