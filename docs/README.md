...
| [`docs/avora-new-state-august-16.md`](avora-new-state-august-16.md) | The **programme plan** to reach the Avora target state — 97 product decisions recorded verbatim as the source of truth, 22 engineering decisions marked separately, and 12 phases of tasks written for AI agents and engineers to execute one at a time or in parallel. Carries the resolutions of both the SWE audit and the security threat review | Yes, until Phase 11 lands |
