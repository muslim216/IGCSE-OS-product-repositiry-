...
reconstruction, and so that the knowledge required to operate MANARA is not held in one
person's memory.
...
| Some students missing | **Expected.** Roster emails that do not match a MANARA account are skipped, not guessed |
...
- Missing students: match the roster email to a MANARA account, or have the student's account
