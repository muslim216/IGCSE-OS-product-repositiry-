...
MIGRATION_PATH = (
    Path(__file__).resolve().parents[1] / "alembic" / "versions" / "0023_narratives.py"
)
...
def test_downgrade_is_a_clean_drop_with_no_other_table_left_referencing_it(
    bound_migration, conn
):
